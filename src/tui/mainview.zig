...
const mainview_fork = @import("mainview_fork.zig");
const ForkCommands = command.Collection(mainview_fork.cmds);
...
/// State for the features this fork adds; see mainview_fork.zig.
fork: mainview_fork.State = .{},
fork_commands: ForkCommands = undefined,
...
pub fn create(allocator: std.mem.Allocator) CreateError!Widget {
    ...
    try self.fork_commands.init(self);
...
const cmds = struct {
    ...
    pub fn add_diagnostic(self: *Self, ctx: Ctx) Result {
        ...
        try mainview_fork.on_add_diagnostic(self, file_path, severity, message, sel);
    ...
    pub fn clear_diagnostics(self: *Self, ctx: Ctx) Result {
        ...
        try mainview_fork.on_clear_diagnostics(self, file_path);
...
pub fn create_editor(self: *Self, now: std.Io.Timestamp) !void {
...
pub fn filelist_view_for(self: *Self, list_id: FileList.Id) ?*filelist_view {
...
pub fn clear_find_in_files_results(self: *Self, list_id: FileList.Id) void {
